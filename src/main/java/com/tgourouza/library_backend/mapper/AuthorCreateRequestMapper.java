...
public class AuthorCreateRequestMapper {
    ...
    public AuthorCreateRequestMapper(LanguageDetector detector) {
        this.detector = detector;
    }

    public AuthorCreateRequest mapToAuthorCreateRequest(AuthorOpenLibrary authorOpenLibrary, AuthorWikidata authorWikidata) {
