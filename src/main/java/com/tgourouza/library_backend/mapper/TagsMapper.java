...
public class TagsMapper {
    ...
    TagsMapper() {
        tagMap.put(Tag.LITERATURE, new HashSet<>(Arrays.asList(
                ...
                "letteratura", "letterario", "letteraria", "canone", "canonico", "canonica", "classico", "classica",
                "literatura", "literario", "literaria", "canon", "canónico", "canónica", "clásico", "clásica",
        ...
        tagMap.put(Tag.PHILOSOPHY, new HashSet<>(Arrays.asList(
                ...
                "filosofia", "filosofico", "filosofica", "metafisica", "etica", "logica", "epistemologia",
                "filosofía", "filosófico", "filosófica", "metafísica", "ética", "lógica", "epistemología",
        ...
        tagMap.put(Tag.RELIGION, new HashSet<>(Arrays.asList(
                ...
                "religion", "religieux", "religieuse", "théologie", "sacré", "sacrée", "écriture", "écritures",
                "église", "foi",
                "religione", "teologia", "sacro", "sacra", "scrittura", "scritture", "chiesa",
                "fede",
                "religión", "religioso", "religiosa", "teología", "sagrado", "sagrada", "escritura", "escrituras",
                "iglesia", "fe",
        ...
        tagMap.put(Tag.HISTORY, new HashSet<>(Arrays.asList(
                "histoire", "history", "historia", "storia", "geschichte", "medieval", "medievale", "médiévale",
                "médiéval",
                "historique", "historic", "historical", "histórico", "storico", "histórica", "storica", "historisch")));
        ...
        tagMap.put(Tag.CULTURE, new HashSet<>(Arrays.asList(
                "culture", "cultural", "civilization", "heritage", "tradition", "custom", "folklore", "artistic",
                "culture", "culturel", "culturelle", "civilisation", "patrimoine", "tradition", "coutume", "folklore",
                "artistique",
                "cultura", "culturale", "civiltà", "patrimonio", "tradizione", "costume", "folclore", "artistico",
                "artistica",
                "cultura", "cultural", "civilización", "patrimonio", "tradición", "costumbre", "folclore", "artístico",
                "artística",
        ...
        tagMap.put(Tag.SOCIOLOGY, new HashSet<>(Arrays.asList(
                ...
                "sociologique", "sociologic", "sociological", "sociológico", "sociológica", "sociologico",
                ...
                // Deutsch
                "soziologie", "soziologisch", "sozialwissenschaft", "gesellschaftlich", "soziologe", "soziologin")));
        tagMap.put(Tag.POLITICS, new HashSet<>(Arrays.asList(
                ...
                // English
                "politics", "political", "politic", "policy", "government", "state", "democracy", "republic",
                "parliament",
                // Français
                "politique", "political", "politic", "politicien", "gouvernement", "état", "démocratie", "république",
                "parlement",
                // Italiano
                "politica", "politico", "politica", "politici", "governo", "stato", "democrazia", "repubblica",
                "parlamento",
                // Español
                "política", "político", "política", "políticos", "gobierno", "estado", "democracia", "república",
                "parlamento",
                // Deutsch
                "politik", "politisch", "politiker", "regierung", "staat", "demokratie", "republik", "parlament",
                ...
                "diplomazia", "diplomatico", "diplomatica", "diplomatici", "diplomatiche", "diplomatico/a",

                // Español
                "política", "político", "política", "políticos", "gobierno", "estado",
                "democracia", "república", "parlamento",
                "diplomacia", "diplomático", "diplomática", "diplomáticos", "diplomáticas", "diplomático/a",
        ...
        tagMap.put(Tag.MYTHOLOGY, new HashSet<>(Arrays.asList(
                // English
                "mythology", "mythological", "myth", "myths", "pantheon", "god", "gods", "hero", "heroes", "deity",
                "divinity",
                // Français
                "mythologie", "mythologique", "mythe", "mythes", "panthéon", "dieu", "dieux", "héros", "héroïne",
                "divinité",
                // Italiano
                "mitologia", "mitologico", "mitologica", "mito", "miti", "pantheon", "dio", "dei", "dea", "eroe",
                "eroi", "eroina", "divinità",
                // Español
                "mitología", "mitológico", "mitológica", "mito", "mitos", "panteón", "dios", "dioses", "diosa", "héroe",
                "héroes", "heroína", "divinidad",
                // Deutsch
                "mythologie", "mythologisch", "mythos", "mythen", "götterwelt", "gott", "götter", "held", "helden",
        ...
        tagMap.put(Tag.LEGEND, new HashSet<>(Arrays.asList(
                ...
                // Italiano
                "leggenda", "leggendario", "leggendaria", "folclore", "saga", "racconto", "eroico", "eroica",
                // Español
                "leyenda", "legendario", "legendaria", "folclore", "saga", "cuento", "heroico", "heroica",
                // Deutsch
                "legende", "legendär", "folklore", "saga", "märchen", "heldenhaft")));

        tagMap.put(Tag.PSYCHOLOGY, new HashSet<>(Arrays.asList(
                // English
                "psychology", "psychological", "psyche", "psychic", "cognitive", "behavior", "behavioral", "mind",
                // Français
                "psychologie", "psychologique", "psyché", "psychique", "cognitif", "cognitive", "comportement",
                "comportemental",
                // Italiano
                "psicologia", "psicologico", "psicologica", "psiche", "psichico", "psichica", "cognitivo", "cognitiva",
                "comportamento", "comportamentale",
                // Español
                "psicología", "psicológico", "psicológica", "psique", "psíquico", "psíquica", "cognitivo", "cognitiva",
                "comportamiento", "conductual",
                // Deutsch
                "psychologie", "psychologisch", "psyche", "psychisch", "kognitiv", "verhalten", "verhaltensbezogen")));

        tagMap.put(Tag.TECHNOLOGY, new HashSet<>(Arrays.asList(
                // English
                "technology", "technological", "technical", "innovation", "engineering", "machine", "digital",
                "robotics", "automation", "ai", "artificial intelligence",
                // Français
                "technologie", "technologique", "technique", "innovation", "ingénierie", "machine", "numérique",
                "robotique", "automatisation", "ia", "intelligence artificielle",
                // Italiano
                "tecnologia", "tecnologico", "tecnologica", "tecnico", "innovazione", "ingegneria", "macchina",
                "digitale", "robotica", "automazione", "ia", "intelligenza artificiale",
                // Español
                "tecnología", "tecnológico", "tecnológica", "técnico", "innovación", "ingeniería", "máquina", "digital",
                "robótica", "automatización", "ia", "inteligencia artificial",
                // Deutsch
                "technologie", "technologisch", "technisch", "innovation", "ingenieurwesen", "maschine", "digital",
        ...
        tagMap.put(Tag.SCIENCE, new HashSet<>(Arrays.asList(
                ...
                "mathématique", "mathematical", "matemático", "matematico", "matemática", "mathematisch", "maths",
                "science", "ciencia", "scienza", "wissenschaft",
                "scientifique", "scientific", "científic", "wissenschaftlich",
                "biologie", "biology", "biología", "biologia",
                "biologique", "biological", "biológico", "biologic", "biologico", "biológica", "biologica",
                "biologisch",
                ...
                "astronomique", "astronomical", "astronómico", "astronómica", "astronomico", "astronomica",
                "astronomisch")));
        tagMap.put(Tag.ECONOMICS, new HashSet<>(Arrays.asList(
                "economic", "ökonomisch",
                // English
                "economics", "economic", "economy", "macroeconomics", "microeconomics", "market", "trade", "finance",
                "capital",
                // Français
                "économie", "économique", "macroéconomie", "microéconomie", "marché", "commerce", "finance", "capital",
                // Italiano
                "economia", "economico", "economica", "macroeconomia", "microeconomia", "mercato", "commercio",
                "finanza", "capitale",
                // Español
                "economía", "económico", "económica", "macroeconomía", "microeconomía", "mercado", "comercio",
                "finanzas", "capital",
                // Deutsch
                "ökonomie", "wirtschaft", "wirtschaftlich", "volkswirtschaft", "betriebswirtschaft", "markt", "handel",
                "finanzen", "kapital")));
        tagMap.put(Tag.ART, new HashSet<>(Arrays.asList(
                "artiste", "artist", "artista", "künstler", "gemälde",
                // English
                "art", "artistic", "fine arts", "visual arts", "painting", "sculpture", "drawing", "printmaking",
                // Français
                "art", "artistique", "beaux-arts", "arts visuels", "peinture", "sculpture", "dessin", "gravure",
                // Italiano
                "arte", "artistico", "artistica", "belle arti", "arti visive", "pittura", "scultura", "disegno",
                "incisione",
                // Español
                "arte", "artístico", "artística", "bellas artes", "artes visuales", "pintura", "escultura", "dibujo",
                "grabado",
                // Deutsch
                "kunst", "künstlerisch", "bildende kunst", "malerei", "skulptur", "zeichnung", "grafik")));
        tagMap.put(Tag.MUSIC, new HashSet<>(Arrays.asList(
                // English
                "music", "musical", "musician", "composer", "song", "melody", "harmony", "rhythm", "orchestra",
                "symphony", "opera",
                // Français
                "musique", "musical", "musicale", "musicien", "musicienne", "compositeur", "compositrice", "chanson",
                "mélodie", "harmonie", "rythme", "orchestre", "symphonie", "opéra",
                // Italiano
                "musica", "musicale", "musicista", "compositore", "compositrice", "canzone", "melodia", "armonia",
                "ritmo", "orchestra", "sinfonia", "opera",
                // Español
                "música", "musical", "músico", "música", "compositor", "compositora", "canción", "melodía", "armonía",
                "ritmo", "orquesta", "sinfonía", "ópera",
                // Deutsch
                "musik", "musikalisch", "musiker", "musikerin", "komponist", "komponistin", "lied", "melodie",
                "harmonie", "rhythmus", "orchester", "sinfonie", "oper")));
        tagMap.put(Tag.EDUCATION, new HashSet<>(Arrays.asList(
                "erziehung", "bildend",
                // English
                "education", "educational", "school", "teaching", "learning", "pedagogy", "didactics", "curriculum",
                // Français
                "éducation", "éducatif", "éducative", "scolaire", "enseignement", "apprentissage", "pédagogie",
                "didactique", "programme",
                // Italiano
                "educazione", "educativo", "educativa", "scolastico", "scolastica", "insegnamento", "apprendimento",
                "pedagogia", "didattica", "curricolo",
                // Español
                "educación", "educativo", "educativa", "escolar", "enseñanza", "aprendizaje", "pedagogía", "didáctica",
                "currículo",
                // Deutsch
                "bildung", "pädagogisch", "schulisch", "unterricht", "lernen", "pädagogik", "didaktik", "lehrplan")));
        tagMap.put(Tag.ROMAN, new HashSet<>(Arrays.asList(
                ...
                // Italiano
                "romanzo", "romanzi", "romanzesco", "romanzesca", "romanziere", "romanziera", "finzione",
                // Español
        ...
        tagMap.put(Tag.BIOGRAPHY, new HashSet<>(Arrays.asList(
                "biographie", "biographique", "biography", "biographical", "biografía", "biográfico", "biografia",
                ...
                "journal", "journalistique", "journalistic", "periódico", "periodístico", "giornale", "giornalistico",
                "zeitung", "journalistisch")));
        tagMap.put(Tag.LETTERS, new HashSet<>(Arrays.asList(
                "lettres", "épistolaire", "letters", "epistolary", "cartas", "epistolar", "lettere", "epistolare",
        ...
        tagMap.put(Tag.TALE, new HashSet<>(Arrays.asList(
                ...
                "conte de fées", "féerique", "fairy tale", "cuento de hadas", "de hadas", "fiaba", "fiabesco",
                "märchen",
                "fable", "fabuleux", "fabular", "fábula", "fabuloso", "favola", "favolistico", "fabel", "fabelhaft")));
        tagMap.put(Tag.ENCYCLOPEDIA, new HashSet<>(Arrays.asList(
                "encyclopédie", "encyclopédique", "encyclopedia", "encyclopedic", "enciclopedia", "enciclopédico",
                "enciclopedico", "enzyklopädie",
                "enzyklopädisch",
                "atlas", "cartographique", "cartographic", "cartográfico", "atlante", "cartografico", "kartographisch",
                "dictionnaire", "lexicographique", "dictionary", "lexicographic", "diccionario", "lexicográfico",
    ...
    public Set<Tag> fromSet(Set<String> tags) {
        ...
        Set<Tag> result = tagMap.entrySet().stream()
                .filter(entry -> normalized.stream().anyMatch(
                        phrase -> entry.getValue().stream().anyMatch(keyword -> containsWholeWord(phrase, keyword))))
        ...
        if (result.contains(Tag.SCIENCE)) {
            ...
            boolean hasPureScience = normalized.stream().anyMatch(
                    phrase -> tagMap.get(Tag.SCIENCE).stream().anyMatch(keyword -> containsWholeWord(phrase, keyword)));
